          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="{{route('show.profile.emp.view')}}" class="sidebar-link"
                      ><i class="mdi mdi-emoticon"></i
                      ><span class="hide-menu"> Profile Details </span></a
                    >
                  </li>
                  ...
                  <li class="sidebar-item">
                    <a href="{{route('dept.list')}}" class="sidebar-link"
                      ...
                      ><span class="hide-menu"> Attendence Daily </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="{{route('dept.list')}}" class="sidebar-link"
                      ><i class="mdi mdi-emoticon"></i
                      ><span class="hide-menu"> Leave Request </span></a
                    >
                  </li>
