              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                       ...
                       <tr>
                           ...
                           <a href="{{url('delete/position').'/'.$position->id}}" class="btn btn-info" >Delete</a></td>
                        </tr>
                 @endforeach
                </tbody>
              </table>
      ...
      <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
              ...
              <a href="{{url('delete/role').'/'.$role->id}}" class="btn btn-info" >Delete</a></td>
            </tr>
               @endforeach
        </tbody>
      </table>
