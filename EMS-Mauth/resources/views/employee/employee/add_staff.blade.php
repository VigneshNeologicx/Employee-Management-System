                    ...
                    <table id="tableid" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        ?>
                           ...
                           <td>
                              <a href="{{url('employee/edit').'/'.$emps->employee_id}}" value="{{$emps->employee_id}}" data-toggle="modal" data-target="#editModal" class="editbtn"><i class="mdi mdi-table-edit"> </i></a>
