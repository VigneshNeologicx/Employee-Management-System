@include('employee.v1.head')
  ...
  <body>
    ...
    >
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <a class="dropdown-item" href="javascript:void(0)"
                    ><i class="mdi mdi-account me-1 ms-1"></i> @if(Auth::guard('employee')->user()->name)
                    {{Auth::guard('employee')->user()->name}} @else {{ Profile }} @endif
                     </a
                  >
      ...
      @include('employee.v1.sidebar')

      @yield('employee')

      @yield('scripts')
      @include('employee.v1.footer')
